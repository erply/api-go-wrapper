...
//GetWarehouses ...
func (cli *erplyClient) GetWarehouses(ctx context.Context) (Warehouses, error) {

	resp, err := cli.sendRequest(ctx, GetWarehousesMethod, map[string]string{"warehouseID": "0"})
	if err != nil {
		return nil, err
	}
